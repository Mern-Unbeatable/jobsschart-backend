...
export const updateConsultantProfileSchema = z.object({
  specialization: i18nStringArray.optional(),
  bio: optionalI18nText(z.string().max(1000, 'Bio must be less than 1000 characters')),
  category: optionalI18nText(z.string().max(200)),
  topics: optionalI18nText(z.string().max(500)),
