...
//                 `Current balance: ${wallet.creditBalance} credits. Please purchase more credits.`
//             );
//         }
...
//     // ✅ FIX: Check for existing PENDING call from this user to this consultant
...
//         log.warn(`Duplicate call prevented: User ${userId} already has a pending call to consultant ${consultantUserId}`);
//         throw new ConflictError('You already have a pending call to this consultant. Please wait for them to respond.');
//     }
...
//     // Create call record with a unique constraint check
//     let call;
//     try {
...
//         });
//     } catch (error) {
//         // If duplicate creation happens, fetch the existing one
//         if (error.code === 'P2002') {
...
//             });
//             if (existingCall) {
//                 log.warn(`Returning existing call instead of creating duplicate`);
//                 call = existingCall;
//             } else {
//                 throw error;
//             }
...
//     };
// }
//   // In class CallService — replace the endCall method with this:
